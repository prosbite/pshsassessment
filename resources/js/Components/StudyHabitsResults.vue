<template>
    <div class="mb-32">
      <div class="flex px-64 mb-32">
          <AssessmentPieChartPercentage :assessmentData="chartData" category="Study Habits" />
      </div>
      ...
      <div class="overflow-x-auto">
          <table class="min-w-full bg-white shadow-lg rounded-lg overflow-hidden">
              <thead class="bg-gray-100 text-gray-700 text-sm uppercase tracking-wider">
                  <tr>
                      <th class="px-6 py-3 text-left">Very Low</th>
                      <th class="px-6 py-3 text-left">Low</th>
                      <th class="px-6 py-3 text-left">Average</th>
                      <th class="px-6 py-3 text-left">High</th>
                      <th class="px-6 py-3 text-left">Very High</th>
                  </tr>
              </thead>
  ...
  onMounted(() => {
    //   console.log(calculatedAssessment.value)
  })
  </script>
